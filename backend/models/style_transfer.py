...
content_image = load_rgb_image('./../images/hong_kong.jpg', size=1024, keep_asp=True).unsqueeze(0)
style = load_rgb_image('./../images/wave.jpg', size=512).unsqueeze(0)
style = preprocess_batch(style)

style_model = Model(ngf=128)
style_model.load_state_dict(torch.load('./pretrained/style_transfer.pt'), False)
